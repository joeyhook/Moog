...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -1029.0, 204.735504, 293.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -1118.0, 160.875, 68.0, 22.0 ],
					"style" : "",
					"text" : "unpack s s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -855.0, -236.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "path"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -837.0, -184.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -1085.0, -246.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ -1087.333374, -173.569901, 186.0, 22.0 ],
					"style" : "",
					"text" : "t b b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -1118.0, 349.0, 325.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1224.15625, 352.476562, 320.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -1025.0, 262.5, 81.0, 22.0 ],
					"style" : "",
					"text" : "prepend plug"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -1122.0, 85.375, 351.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -1025.0, -23.0, 167.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -977.0, -63.0, 134.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -958.0, -254.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -751.0, 289.8125, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -816.5, 971.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -751.0, 332.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -782.0, -612.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -700.0, 573.25, 34.0, 22.0 ],
					"style" : "",
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -830.0, 695.224976, 37.0, 22.0 ],
					"style" : "",
					"text" : "2 0.4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -830.0, 618.224976, 37.0, 22.0 ],
					"style" : "",
					"text" : "1 0.7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -783.0, 695.224976, 37.0, 22.0 ],
					"style" : "",
					"text" : "2 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -783.0, 618.224976, 37.0, 22.0 ],
					"style" : "",
					"text" : "1 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, -33.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 544.0, -61.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 873.0, 273.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 846.114563, 273.731781, 150.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -93.416672, 391.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "selector~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.0, 29.0, 164.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 104.515625, 23.992195, 164.0, 23.0 ],
					"style" : "",
					"text_width" : 55.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ -647.5, 558.014648, 44.0, 22.0 ],
					"style" : "",
					"text" : "gate 3"
				}
...
,
					"snapshot" : 					{
						...
						"snapshot" : 						{
							...
							"pluginsavedname" : "/Volumes/HD/Applications/NonLinearMoogVCFwSideChain.vst",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 865.0, 281.047974, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 873.0, 279.047974, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 379.200012, 15.0, 23.0, 61.992195 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 277.200012, 54.117195, 100.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 338.203918, 15.0, 37.992195, 37.992195 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 447.5, 106.625, 435.0, 64.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 104.515625, 80.117195, 522.0, 76.0 ],
					"range" : 50,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -807.0, 436.0, 37.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 999.90625, 272.731781, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 793.447876, 272.731781, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 531.885376, 23.992195, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 104.515625, 50.617195, 65.0, 22.0 ],
					"style" : "",
					"text" : "allnotesoff"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 531.885376, 47.992195, 100.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 25.96875, 394.110474, 70.0, 22.0 ],
					"style" : "",
					"text" : "selector~ 4"
				}
...
,
					"patching_rect" : [ -80.666672, 345.204224, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -566.291687, 302.371918, 392.25, 702.506165 ],
					"proportion" : 0.99,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 14.0, 624.260376, 146.992188 ],
					"proportion" : 0.99,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 29.15625, 409.929688, 754.0, 109.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ -670.833333, 0.0, 156.0, 0.0, 156.0, 354.0, 86.46875, 354.0 ],
					"source" : [ "obj-221", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-75", 0 ],
					"midpoints" : [ -257.0, -186.0, -116.0, -186.0, -116.0, 420.0, 0.0, 420.0, 0.0, 347.0, 35.46875, 347.0 ],
					"source" : [ "obj-295", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 873.0, 168.03125, 494.125, 168.03125 ],
					"order" : 0,
					"source" : [ "obj-438", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ -661.5, 301.859375, 60.96875, 301.859375 ],
					"order" : 1,
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 35.46875, 706.855194, -560.5, 706.855194 ],
					"order" : 1,
					"source" : [ "obj-75", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 35.46875, 709.355194, -456.25, 709.355194 ],
					"order" : 0,
					"source" : [ "obj-75", 0 ]
				}
